...
namespace csharp_cappef.Migrations
{
    ...
    [Migration("20220607144646_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("csharp_cappef.Program+Course", b =>
                {
            ...
            modelBuilder.Entity("csharp_cappef.Program+CourseImage", b =>
                {
            ...
            modelBuilder.Entity("csharp_cappef.Program+Review", b =>
                {
            ...
            modelBuilder.Entity("csharp_cappef.Program+Student", b =>
                {
                    b.Property<int>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStudent", b =>
                {
                    b.HasOne("csharp_cappef.Program+Course", null)
                        .WithMany()
                        .HasForeignKey("FrequentedCoursesCourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("csharp_cappef.Program+Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("csharp_cappef.Program+CourseImage", b =>
                {
                    b.HasOne("csharp_cappef.Program+Course", "Course")
                        .WithOne("CourseImage")
                        .HasForeignKey("csharp_cappef.Program+CourseImage", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("csharp_cappef.Program+Review", b =>
                {
                    b.HasOne("csharp_cappef.Program+Student", "Student")
                        .WithMany("Reviews")
